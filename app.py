...
model.load_state_dict(torch.load('adam20_0001_finetuningdo.pt', map_location=torch.device('cpu'))) # Ganti dengan nama file model Anda dan sesuaikan dengan perangkat yang digunakan
model.eval()
